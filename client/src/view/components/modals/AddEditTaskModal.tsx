...
interface IProps {
  ...
  setEditTaskModalOpen?: ReactDispatch<SetStateAction<boolean>>;
  taskIndex?: number;
  prevColIndex?: number;
}

const AddEditTaskModal = ({ type, device, isEditTaskModalOpen, setEditTaskModalOpen, taskIndex, prevColIndex = 0 }: IProps) => {
  ...
  return (
    <Modal setVisible={setEditTaskModalOpen} visible={isEditTaskModalOpen} title={type}>
      <div
        className={
          device === 'mobile'
      ...
      >
        <div className="">
          <h3 className="modal-header">{type === 'edit' ? 'Edit' : 'Add New'} Task</h3>
